    ...
    opts = {
      ...
      textobjects = {
        ...
        move = {
          ...
          set_jumps = true,
          goto_next_start = {
            ["<leader>jk"] = { query = "@block.outer", desc = "Next block start" },
            ["<leader>jf"] = { query = "@function.outer", desc = "Next function start" },
            ["<leader>ja"] = { query = "@parameter.inner", desc = "Next parameter start" },
          },
          goto_next_end = {
            ["<leader>jK"] = { query = "@block.outer", desc = "Next block end" },
            ["<leader>jF"] = { query = "@function.outer", desc = "Next function end" },
            ["<leader>jA"] = { query = "@parameter.inner", desc = "Next parameter end" },
          },
          goto_previous_start = {
            ["<leader>kk"] = { query = "@block.outer", desc = "Previous block start" },
            ["<leader>kf"] = { query = "@function.outer", desc = "Previous function start" },
            ["<leader>ka"] = { query = "@parameter.inner", desc = "Previous parameter start" },
          },
          goto_previous_end = {
            ["<leader>kK"] = { query = "@block.outer", desc = "Previous block end" },
            ["<leader>kF"] = { query = "@function.outer", desc = "Previous function end" },
            ["<leader>kA"] = { query = "@parameter.inner", desc = "Previous parameter end" },
          },
        },
        swap = {
          enable = true,
